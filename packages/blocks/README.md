...
Agents get the component grammar, the token rules and an edit-time design gate from `bun add -d @urbicon-ui/design`, then `bunx urbicon init --hook` ([`@urbicon-ui/design`](https://ui.urbicon.de/ai)).
