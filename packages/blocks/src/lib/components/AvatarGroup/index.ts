...
/**
 * @summary An overlapping row of avatars with a +N overflow chip.
...
export interface AvatarGroupProps
  ...
  items: AvatarProps[];
  /** Shared size applied to every avatar and the overflow chip. One of xs, sm, md (default), lg, xl, 2xl. */
