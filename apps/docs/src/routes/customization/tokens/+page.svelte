...
@theme {
  ...
  const typographyScale = [
    ...
    { utility: 'text-xs', variable: '--text-xs', value: '0.75rem', pixels: '12px', uses: 111 },
    { utility: 'text-sm', variable: '--text-sm', value: '0.875rem', pixels: '14px', uses: 156 },
    { utility: 'text-base', variable: '--text-base', value: '1rem', pixels: '16px', uses: 89 },
    { utility: 'text-lg', variable: '--text-lg', value: '1.125rem', pixels: '18px', uses: 36 },
    { utility: 'text-xl', variable: '--text-xl', value: '1.25rem', pixels: '20px', uses: 12 },
    { utility: 'text-2xl', variable: '--text-2xl', value: '1.5rem', pixels: '24px', uses: 3 }
  ];

  const weightScale = [
    { utility: 'font-normal', variable: '--font-weight-normal', value: '400', uses: 4 },
    { utility: 'font-medium', variable: '--font-weight-medium', value: '500', uses: 64 },
