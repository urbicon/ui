...
--blocks-shadow-md: var(--color-shadow-md);`;
  ...
  const typographyScale = [
    ...
    { utility: 'text-base', variable: '--text-base', value: '1rem', pixels: '16px', uses: 97 },
    { utility: 'text-lg', variable: '--text-lg', value: '1.125rem', pixels: '18px', uses: 40 },
  ...
  const weightScale = [
    ...
    { utility: 'font-semibold', variable: '--font-weight-semibold', value: '600', uses: 54 },
