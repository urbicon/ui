...
<Section marker="01" id="examples" title="Examples">
  <div class="space-y-8">
    <CodeExample
      title="Cycle vs. toggle"
      description="Default cycles light → dark → system. Pass strategy='toggle' to flip between light and dark only."
      isolate
