...
<SeoMeta
  title="ResourceTimeline Component"
  description="One lane per room, chair or vehicle against a day axis: each item is a bar over the days it occupies, stacked where two overlap."
/>
...
>
  ...
  <Section marker id="installation" title="Installation">
    <CodeExample
      title="Import"
      code={`import { ResourceTimeline } from '@urbicon-ui/blocks';`}
      language="svelte"
      preview={false}
    />
  </Section>
