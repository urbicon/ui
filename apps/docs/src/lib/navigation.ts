...
const allNavigationItems: NavItem[] = [
    ...
    children: [
      {
        ...
        children: [
          ...
          { name: 'DateRangePicker', href: '/blocks/components/date-range-picker' },
          ...
          { name: 'NumberInput', href: '/blocks/components/number-input' },
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'CopyButton', href: '/blocks/components/copy-button' },
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'Scroller', href: '/blocks/primitives/scroller' },
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'AvatarGroup', href: '/blocks/components/avatar-group' },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Server-Rendered Data', nameKey: 'nav.tableSsr', href: '/table/ssr' },
