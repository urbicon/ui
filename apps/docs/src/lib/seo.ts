/**
 * Central site metadata for SEO/OG — single source of truth for SeoMeta.svelte,
...
export const DEFAULT_DESCRIPTION =
  'Zero-dependency Svelte 5 component library with Tailwind 4, AI-native DX (MCP server, llms.txt), and OKLCH design tokens. Fully accessible and customizable.';
