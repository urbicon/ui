...
/** The salon's name — the page headline and the agent's grounding read the same value. */
export const SALON_NAME = 'Bleecker & Bond';

export const SERVICES: SalonService[] = [
  { id: 'bleecker', label: 'The Bleecker Cut', minutes: 45, price: '$95' },
  { id: 'dry', label: 'Dry Cut & Finish', minutes: 30, price: '$70' },
  { id: 'beard', label: 'Beard Architecture', minutes: 30, price: '$55' },
  { id: 'colour', label: 'Colour Consultation', minutes: 20, price: '$0' }
];

export const STYLISTS: SalonStylist[] = [
  { id: 'io', name: 'Io', workdays: [1, 2, 3, 4, 5] },
  { id: 'sable', name: 'Sable', workdays: [2, 3, 4, 5, 6] },
  { id: 'ren', name: 'Ren', workdays: [1, 3, 5, 6] }
];
